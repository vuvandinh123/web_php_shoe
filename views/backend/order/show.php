...
$id = $_REQUEST['id'];
$list_order = Order::where([['status', '!=', '0'], ['id', '!=', $id]])->get();
$order = Order::find($id);
if ($order == null) {
    MyClass::set_flash('message', ['type' => 'success', 'msg' => 'Đơn hàng không tồn tại']);
        ...
        <div class="card">
            <div class="card-header">
                <div class="d-flex justify-content-between mb-3">
                    ...
                    <!-- <a title="Quay lại" class="btn bg-primary rounded-0" href="?option=order&sort=desc&page=1"> -->
                    <!-- <img width="20px" height="20px" src="../public/image/icon/arrow.png" alt=""> Quay lại</a> -->
                    <a title="Quay lại" href="?option=order&sort=desc&page=1" class="back">
                    ...
                    <div>
                        ...
                        <a title="Thêm vào thùng rác" href="?option=order&cat=delete&id=<?=$id?>"

        ...
        <div class="card">
            <div class="card-header">
                <div class="d-flex justify-content-between mb-3">
                    ...
                    <a title="Quay lại" href="?option=topic&sort=desc&page=1" class="back">
                ...
                <table class="table table-striped table-hover">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><?=date_format($topic->created_at,"H:i:s d/m/Y ") ?></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td><?=date_format($topic->updated_at,"H:i:s d/m/Y ") ?></td>
                        </tr>
                        <tr>

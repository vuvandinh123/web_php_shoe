            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item"><a href="?option=product&sort=desc&page=1">Danh mục</a></li>
    ...
    <section class="content">
        <div class="card">
            <div class="card-header">
                <div class="d-flex justify-content-between mb-3">
                    ...
                    <a title="Quay lại" class="btn bg-primary rounded-0 fw-bold"
                        href="?option=product&sort=desc&page=1">
            ...
            <div class="card-body">
                ...
                <form action="?option=product&cat=process" method="post" enctype="multipart/form-data">
                    <div class="row">
                        <div class="col-9">

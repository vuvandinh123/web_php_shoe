            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item"><a href="index.php?option=banner&page=1">banner</a></li>
        ...
        <div class="card">
            <div class="card-header">
                <div class="d-flex justify-content-between mb-3">
                    ...
                    <a title="Quay lại" href="?option=banner&page=1" class="back">
                ...
                <table class="table table-striped table-hover">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><?=date_format($banner->created_at,"H:i:s d/m/Y ") ?></td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td><?=date_format($banner->updated_at,"H:i:s d/m/Y ") ?></td>
                        </tr>
                        <tr>

            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item"><a href="index.php?option=page&sort=desc&page=1">Trang đơn</a></li>
        ...
        <div class="card">
            <div class="card-header">
                <div class="d-flex justify-content-end mb-3">
                    ...
                    <div>
                        <a class="btn bg-primary rounded-0" href="?option=page&sort=desc&page=1">
                            ...
                            <td class="">
                                ...
                                <td class="text-right">
                                    ...
                                    <a title="Khôi phục" class="mx-2 btn btn-primary"
                                        href="index.php?option=page&cat=restore&page=<?=$j?>&id=<?= $value->id ?>"><i
                                            class="fa-solid fa-rotate-right"></i></a>
                                    <a title="Xóa" class="mr-2 btn btn-danger"
                                        href="index.php?option=page&cat=destroy&page=<?=$j?>&id=<?= $value->id ?>"><i
            ...
            <div class="card-footer">
                <div class="d-flex justify-content-between mb-3">
                    ...
                    <div>
                        ...
                        <ul class="pagination">
                                <li class="page-item">
                                    <span class="page-link"><a href="?option=page&cat=recycle&page=1">Đầu</a></span>
                                </li>
                                <?php for($i=1;$i<=$number_of_page;$i++): ?>
                                <li class="page-item"> <a class=' page-link <?php if($j==$i)echo 'bg-primary' ?>'
                                        href='?option=page&cat=recycle&page=<?=$i?>'><?=$i?></a></li>
                                <?php endfor; ?>
                                <li class="page-item">
                                    <a class="page-link" href="?option=page&cat=recycle&page=<?=--$i?>">Cuối</a>
                                </li>
                            </ul>
                        </nav>
                    </div>

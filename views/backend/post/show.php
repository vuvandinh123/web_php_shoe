        ...
        <div class="card">
            <div class="card-header">
                <div class="d-flex justify-content-between mb-3">
                    ...
                    <a title="Quay lại" href="?option=post&sort=desc&page=1" class="back">
                    ...
                    <div>
                        <a title="sửa" href="?option=post&cat=edit&id=<?=$id?>" class="btn bg-primary rounded-0 "><i
                                class="fa-solid fa-pen-to-square"></i></a>
                        <a title="Thêm vào thùng rác" href="?option=post&cat=delete&id=<?=$id?>"

            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item"><a href="index.php?option=category&sort=desc&page=1">Thương hiệu</a></li>
        ...
        <div class="card">
            <div class="card-header">
                <div class="d-flex justify-content-end mb-3">
                    ...
                    <div>
                        <a class="btn bg-primary rounded-0" href="?option=category&sort=desc&page=1">
                            ...
                            <td class="">
                                ...
                                <td class="text-right">
                                    ...
                                    <a title="Khôi phục" class="mx-2 btn btn-primary"
                                        href="index.php?option=category&cat=restore&sort=<?=$sort?>&page=<?=$j?>&id=<?= $value->id ?>"><i
                                            class="fa-solid fa-rotate-right"></i></a>
                                    <a title="Xóa" class="mr-2 btn btn-danger"
                                        href="index.php?option=category&cat=destroy&sort=<?=$sort?>&page=<?=$j?>&id=<?= $value->id ?>"><i

                ...
                <div class="d-flex justify-content-between mb-3">
                    <div class="d-flex">
                        ...
                        <div class="form-check mx-3 position-relative">
                            ...
                            <div id="dropdow_item">
                                <a class="d-block text-center" href="?option=accessory&sort=desc&page=1&hienthi=5">5</a>
                                <a class="d-block " href="?option=accessory&sort=desc&page=1&hienthi=10">10</a>
                                <a class="d-block " href="?option=accessory&sort=desc&page=1&hienthi=15">15</a>
                    ...
                    <div><a href="?option=accessory&cat=create" class="btn bg-primary rounded-0 "><i class="fa-solid fa-plus"></i></a><button
                            ...
                            <tr>
                                ...
                                <td class="text-right">
                                    ...
                                    <a title="Tắt" class="btn btn-primary"
                                        href="index.php?option=accessory&cat=status&sort=<?=$sort?>&page=<?=$j?>&id=<?=$value->id?>">
                                        <i class="fa-solid fa-toggle-on"></i></a>
                                    <?php else:?>
                                    <a title="Bật" class="btn btn-danger"
                                        href="index.php?option=accessory&cat=status&sort=<?=$sort?>&page=<?=$j?>&id=<?=$value->id?>"><i
                                            class="fa-solid fa-toggle-off "></i></a>
                                    <?php endif;?>
                                    <a title="sửa" class="mx-2 btn btn-warning"
                                        href="index.php?option=accessory&cat=edit&id=<?=$value->id?>"><i
                                            class="fa-solid fa-pen-to-square"></i></a>
                                    <a title="xem" class="mr-2 btn btn-primary"
                                        href="index.php?option=accessory&cat=show&id=<?=$value->id?>"><i
                                            class="fa-solid fa-eye"></i></a>
                                            <a title="thêm ảnh" class="mr-2 btn btn-info"
                                        href="index.php?option=accessory&cat=addimage&id=<?=$value->id?>"><i class="fa-solid fa-images"></i></a>
                                    <a id="liveToastBtn" title="Xóa vào thùng rác" class="btn btn-danger mr-2"
                                        href="index.php?option=accessory&cat=delete&sort=<?=$sort?>&page=<?=$j?>&id=<?=$value->id?>"><i
                            ...
                            <ul class="pagination">
                                <li class="page-item">
                                    <span class="page-link"><a
                                            href="?option=accessory&sort=<?=$sort ?>&page=1">Đầu</a></span>
                                </li>
                                <?php for($i=1;$i<=$number_of_page;$i++): ?>
                                <li class="page-item"> <a class=' page-link <?php if($j==$i)echo 'bg-primary' ?>'
                                        href='?option=accessory&sort=<?=$sort?>&page=<?=$i?>'><?=$i?></a></li>
                                <?php endfor; ?>
                                <li class="page-item">
                                    <a class="page-link" href="?option=accessory&sort=<?=$sort ?>&page=<?=--$i?>">Cuối</a>
                                </li>
                            </ul>
                        </nav>
                    </div>
                    <div><a class="btn bg-primary rounded-0 " href="index.php?option=accessory&cat=recycle">Thêm</a>
                        <a class="btn bg-danger rounded-0 " href="index.php?option=accessory&cat=recycle&page=1">Thùng
                            rác</a>
                    </div>

        ...
        <div class="card">
            <div class="card-header">
                <div class="d-flex justify-content-between mb-3">
                    ...
                    <a title="Quay lại" href="?option=accessory&sort=desc&page=1" class="back">
                    ...
                    <div>
                        <a title="sửa" href="?option=accessory&cat=edit&id=<?=$id?>" class="btn bg-primary rounded-0 "><i
                                class="fa-solid fa-pen-to-square"></i></a>
                        <a title="Thêm vào thùng rác" href="?option=accessory&cat=delete&id=<?=$id?>"
